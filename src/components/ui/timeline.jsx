  ...
  return (
    <div
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className={`flex justify-start pt-10 md:gap-10 ${index === 0 ? 'md:pt-12' : 'md:pt-40'}`}>
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-surface border border-primary/30 p-2" />
              </div>
              <h3
