    ...
    <AceternityNavbar>
      <NavBody className="bg-background/80 border border-border">
        ...
        <div className="flex items-center gap-4 z-20 relative">
          ...
          <NavbarButton variant="primary" className="bg-brand text-white hover:brightness-110 border-none">Get Tickets</NavbarButton>
        </div>
      </NavBody>
      ...
      <MobileNav className="bg-background/90 border border-border">
        ...
        <MobileNavMenu isOpen={isOpen} onClose={() => setIsOpen(false)} className="bg-surface border border-border">
          <div className="flex flex-col gap-4 px-4 w-full">
            ...
            <NavbarButton variant="primary" className="w-full text-center bg-brand text-white mt-4 hover:brightness-110 border-none">Get Tickets</NavbarButton>
          </div>
        </MobileNavMenu>
      </MobileNav>
    </AceternityNavbar>
